...
class ProveedorController extends Controller
{
    ...
    public function create()
    {
    			...
    			//Retornaremos a la vista create que esta dentro de las carpetas .
    ...
    public function store(PersonaFormRequest $request) 
    {
    		...
    		$persona->tipo_persona='Proveedor';// lo defino el tipo de persona como Cliente de forma automatica
    ...
    public function show($id)
    {
    		...
    		//Aqui retornamos la vista show y le enviamos como parametros la persona correpondiente al $id; atravez del llamado al modelo categoria (por ahora este metodo no se esta utilizando)
    		return view("compras.proveedor.show",["persona"=>Persona::findOrdFail($id)]);
    }
    ...
    public function edit($id)
    {
    		...
    		return view("compras.proveedor.edit",["persona"=>Persona::findOrFail($id)]);// redirecciono a mi formulario edit con los datos especifico de la persona que quiero editar.
    }
    ...
    public function update(PersonaFormRequest $request,$id)
    {
    		...
    		return Redirect::to('compras/proveedor');// aqui redireccionamos al archivo index que esta dentro de las carpetas almacen y categoria
