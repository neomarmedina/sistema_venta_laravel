...
class GraficasController_chart extends Controller
{
    /**
    ...
    //esta función devuelve el ultimo dia del mes, recibiendo el año y me spor parametros
...
//la adaptare a los articulos mas vendidos
    ...
    public function index()
    {
        ...
        //return view('listados.listado_graficas',["anio"=>$anio,"mes"=>$mes]);
               ...
               return view('listado.graficas2.create',["anio"=>$anio,"mes"=>$mes]);
    }
