...
$this->SetXY(16	,25);				
$this->Cell(150,6,utf8_decode("RAZON SOCIAL: $razon"),0,0,'L',false);
...
$this->Cell(60,6,utf8_decode("$tipo_documento          :".$rif_empresa),0,0,'L',false);
...
//Esto es por cada articulo que tenga la venta se dibujara un registro
   ...
   $cantidad=$detalle_listado['cantidadnueva'];
   ...
   $total_devolucion=$detalle_listado['total_devolucion'];;
...
$this->Cell(20,4,utf8_decode(" "),0,0,'R',false);
$this->Cell(4,4,utf8_decode(" "),0,0,'L',false);
$this->Cell(20,4,utf8_decode("TOTAL DEVOLUCIÓN:"),0,0,'R',false);
$this->Cell(20,4,utf8_decode($total_devolucion),0,0,'R',false);

}
}

//Estos valores los debo pasar por parametros a LA FUNCION : cuerpo_completo()
foreach($detalles_devolucion as $detalles) 
{
/*
$razon=$detalles->tienda; 
$direccion='direccion';
$rif_empresa=$detalles->tienda_rif;
$codigo_tienda=$detalles->codigo_tienda;
$tlf_tienda=$detalles->tienda_tlf;
$vendedor=$detalles->vendedor;
$cedula_vendedor=$detalles->cedula_vendedor;//es un ejemplo , hay que colocar la que corresponde $pdf->cuerpo_completo() para poder imprimirlos en el pdf

$tipo_comprobante=$detalles->tipo_comprobante;
*/

$razon=$detalles->cliente;//nombre del cliente
$direccion=$detalles->direccion_cliente;
$rif_empresa=$detalles->num_documento;
$tipo_documento=$detalles->tipo_documento;
$codigo_tienda=$detalles->codigo_cliente;
$tlf_tienda=$detalles->telefono_cliente;
$vendedor=$detalles->vendedor;
$cedula_vendedor=$detalles->cedula_vendedor;//es un ejemplo , hay que colocar la que corresponde $pdf->cuerpo_completo() para poder imprimirlos en el pdf
...
$detalle=json_encode($detalles_devolucion);
