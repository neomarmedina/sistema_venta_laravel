...
<!-- Content Wrapper. Contains page content -->
  <div class="content-header">
    ...
    <section class="content-header">
      <h1>
        Tendencias del año en curso Dinamica
        <small>Módulo Estadístico</small>
      </h1>
      <ol class="breadcrumb">
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Compras vs Ventas (Bsf)</h3>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Compras vs Ventas (Cantidades)</h3>
      ...
      datasets: [
        {
          ...
          data                : <?php session_start();  echo "[1, 2, 2, 4, 5, 6, 7,1, 2, 2, 4, 5, 6, 7]"; ?>
        },
        {
          label               : 'Digital Goods',
          ...
          data                : [1, 2, 2, 4, 5, 6, 7,1, 2, 2, 4, 5, 6, 7]
        }
      ]
    }
